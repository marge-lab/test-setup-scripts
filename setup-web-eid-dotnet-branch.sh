...
# Terminal-resolver (kasutatud nii build-logi kui live-logi akna avamiseks).
# Liigutatud algusesse, et oleks defineeritud enne kõiki kasutuskohti.
resolve_term_name() {
  local cmd path
...
# (WebEid.Security version, dependency-d).
...
clear
echo -e "\${G}================================================================\${N}"
echo -e "\${G}  WebEid .NET HARU — EHITUSE LIVE LOGI (dotnet)\${N}"
echo -e "\${G}================================================================\${N}"
echo ""
