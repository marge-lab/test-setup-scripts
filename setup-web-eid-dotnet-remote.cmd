@echo off
REM ============================================================
REM Web eID .NET naiterakenduse paigaldus + ngrok -- Windows entry point
REM
REM See .cmd-fail on lihtsalt kaivitaja: kontrollib, kas Python
REM on paigaldatud, ja kui pole, pakub winget-iga installimist.
REM Tegelik too toimub `setup-web-eid-dotnet-remote.py`-failis.
REM
REM Kasutus:
REM   1. Topeltklikk failil, VOI
REM   2. cmd-aknas:  setup-web-eid-dotnet-remote.cmd [--profile dev|prod]
REM
...
if "!PYTHON_CMD!"=="" (
    ...
    if "!PYTHON_CMD!"=="" (
        ...
        echo   3. Kaivita skript uuesti: .\setup-web-eid-dotnet-remote.cmd
        echo.
        pause
        exit /b 0
    )
...
echo Kaivitan setup-web-eid-dotnet-remote.py...
echo.
!PYTHON_CMD! "%~dp0setup-web-eid-dotnet-remote.py" %*
