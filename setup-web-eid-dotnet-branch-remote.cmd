@echo off
REM ============================================================
REM Web eID .NET haru-test + ngrok -- Windows entry point
REM
REM See .cmd-fail on lihtsalt kaivitaja: kontrollib, kas Python
REM on paigaldatud, ja kui pole, pakub winget-iga installimist.
REM Tegelik too toimub `setup-web-eid-dotnet-branch-remote.py`-failis.
REM
REM Kasutus:
REM   1. Topeltklikk failil (kusib haru interaktiivselt), VOI
REM   2. cmd-aknas:  setup-web-eid-dotnet-branch-remote.cmd [--branch HARU] [--profile dev|prod]
REM
...
if "!PYTHON_CMD!"=="" (
    ...
    if "!PYTHON_CMD!"=="" (
        ...
        echo   1. Sulge see aken
        echo   2. Ava UUS cmd-aken Start-menyyst
        echo   3. Kaivita skript uuesti: .\setup-web-eid-dotnet-branch-remote.cmd
        echo.
        pause
        exit /b 0
    )
...
echo Kaivitan setup-web-eid-dotnet-branch-remote.py...
echo.
!PYTHON_CMD! "%~dp0setup-web-eid-dotnet-branch-remote.py" %*
